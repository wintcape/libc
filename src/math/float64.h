...
// Global constants.
#define INFINITY_64        ( 1e30*1e30 )          /** @brief Placeholder value for floating point number overflow. */
#define FLOAT_EPSILON_64   1.192092896e-07        /** @brief Smallest possible non-zero floating point number. */
